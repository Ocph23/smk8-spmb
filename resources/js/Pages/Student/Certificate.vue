    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                <div class="flex items-center">
                    <svg
                        class="w-12 h-12 text-green-500 mr-4"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p
                                ...
                                class="font-medium"
                            >
                                {{ student.verification_status === 'pending' ? 'Menunggu Verifikasi' : student.verification_status === 'verified' ? 'Terverifikasi' : 'Ditolak' }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center">
                <a
                    :href="route('student.certificate.print', student.registration_number)"
                    target="_blank"
