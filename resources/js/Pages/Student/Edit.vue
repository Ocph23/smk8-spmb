...
const getFileName = (fieldName, existingPath) => {
                    ...
                    <div v-show="currentStep === 3" class="space-y-6">
                        ...
                        <div v-for="doc in registrationDocuments" :key="doc.id">
                            ...
                            <input type="file" 
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                            <p v-if="getFileName(doc.field_name, student[doc.field_name])" 
                                :class="hasExistingFile(doc.field_name) ? 'text-blue-600' : 'text-green-600'" 
                                class="text-sm mt-1">
                                {{ getFileName(doc.field_name, student[doc.field_name]) }}
                            </p>
