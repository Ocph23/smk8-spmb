    ...
    <AdminLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="mb-4">
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 border border-blue-200 px-3 py-1.5 text-xs font-medium text-blue-700">
                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        {{ currentAcademicYear ? `Menampilkan data untuk: ${currentAcademicYear.name}` : 'Semua tahun ajaran' }}
                    </span>
                </div>
                ...
                <div class="bg-white shadow-sm sm:rounded-lg mb-8">
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <Link :href="route('admin.schedules')"
